...
module usb_hid_host (
    ...
    output usb_oe,                // USB output enable
...
reg [7:0] regs [6:0];     // 0 (VID_L), 1 (VID_H), 2 (PID_L), 3 (PID_H), 4 (INTERFACE_CLASS), 5 (INTERFACE_SUBCLASS), 6 (INTERFACE_PROTOCOL)
